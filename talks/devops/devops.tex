...
\begin{frame}{SSH}
  \begin{itemize}
    ...
    \item ssh tunnelling
    \item use ed25519 elliptic curve key pairs, 256 bits of randomness
...
\begin{frame}{Mosh}
  \begin{itemize}
    \item Mobile shell
    \item long running ssh sessions
    \item supports roaming between networks
    \item intermittent connection does not kill session
  \end{itemize}
\end{frame}
